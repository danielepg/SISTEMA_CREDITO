...
<body class=" bg-body-secondary ">
    ...
    <button class="btn btn-info float-end mx-3 my-2">
        <a class=" text-decoration-none text-black" href="nuevo_empleado.php">Nuevo Empleado</a>
    </button>
    <h2 class="px-3 w-auto">Lista Empleados</h2>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="padding:0px 8px;"><button class="text-white rounded border-0 py-1 px-2 bg-secondary float-end m-2">
                        <a class=" text-decoration-none text-white" href="editar_empleado.php">Editar</a>
                    </button></td>
