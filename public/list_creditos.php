...
<h2 class="text-center">Clientes</h2>
    ...
    <br/>
        ...
        <tbody>
            <?php 
                $query = "SELECT * FROM transacciones INNER JOIN clientes on transacciones.ClienteID = clientes.ClienteID 
                INNER JOIN creditos on transacciones.CreditoID = creditos.CreditoID";
                ...
                <tr>
                    ...
                    <td><?php echo $row['cliente.Nombre']. $row['cliente.Apellido'] ?></td>                    
                    <td><?php echo $row['Monto_parcial']  ?></td>
                    <td><?php echo $row['Saldo']  ?></td>
                    <td><?php echo $row['MontoCredito']  ?></td>
